...
class AlpenEeDaToolRealDaSuccessTest(AlpenEeDaToolTestBase):
    ...
    def main(self, ctx):
        ...
        report = wait_for_expected_root_report(
            bitcoin,
            sequencer,
        ...
        assert report["expected_state_root"] == report["reconstructed_state_root"]
        assert report["state_root_matches_expected"] is True
