...
@flexitest.register
class RevertChainstateTest(DbtoolMixin):
    """Test reverting chainstate to a non-checkpointed block"""
    ...
    def main(self, ctx: flexitest.RunContext):
        ...
        wait_until(
            ...
            error_with="not syncing blocks after revert chainstate",
            timeout=30,
        )
        ...
        self.info(
            "Successfully reverted to block outside checkpointed range and resumed processing"
        )
        return True
