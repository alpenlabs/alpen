...
class L1BlockCommitment:
    ...
    blkid: str = field(default_factory=lambda: hex_bytes_repeated(0))  # TODO(STR-3692): more type safe
...
class GenesisL1View:
    ...
    last_11_timestamps: list[int] = field(default_factory=lambda: [0] * 11)  # TODO(STR-3692): more type safe
