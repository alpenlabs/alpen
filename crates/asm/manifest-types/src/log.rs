...
// Serde implementations delegate to VariableList's serde support (transparent wrapper)
impl serde::Serialize for AsmLogEntry {
...
impl<'de> serde::Deserialize<'de> for AsmLogEntry {
...
impl BorshDeserialize for AsmLogEntry {
    fn deserialize_reader<R: borsh::io::Read>(reader: &mut R) -> borsh::io::Result<Self> {
        ...
        AsmLogEntry::from_ssz_bytes(&ssz_bytes).map_err(|e| {
            borsh::io::Error::new(
