...
use crate::{AsmError, AsmManifestMmr, Mismatched, Subprotocol, SubprotocolId};
...
pub struct ChainViewState {
    ...
    pub manifest_mmr: AsmManifestMmr,
}

impl ChainViewState {
    /// Destructures the chain view into its constituent parts.
    pub fn into_parts(self) -> (HeaderVerificationState, AsmManifestMmr) {
