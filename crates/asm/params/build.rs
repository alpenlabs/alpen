...
fn main() {
    ...
    let entry_points = ["admin.ssz"];
    let base_dir = "ssz";
    let crates = ["strata_identifiers", "strata_predicate"];
    ...
    .expect("Failed to generate ASM params SSZ types");

    println!("cargo:rerun-if-changed=ssz/admin.ssz");
}
