...
mod tests {
    ...
    /// Prints the fixture pinning the Python SSZ offset parsing in
    /// `functional-tests/tests/checkpoint/checkpoint_payload_fixture.json`.
    ///
    /// Regenerate with:
    /// `cargo test -p strata-test-utils-l2 dump_checkpoint_payload_fixture -- --ignored
    /// --nocapture`
    #[test]
    #[ignore = "fixture generator, run manually"]
    fn dump_checkpoint_payload_fixture() {
        ...
        println!(
            r#"{{
  "_note": "generated by dump_checkpoint_payload_fixture in strata-test-utils-l2; pins Python SSZ offset parsing",
  "payload_ssz_hex": "{}",
  "epoch": 7,
  "l1_height": 1234,
  "l2_slot": 99,
