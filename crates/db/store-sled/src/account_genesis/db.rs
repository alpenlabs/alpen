...
use strata_db_types::{DbError, DbResult, traits::AccountGenesisDatabase};
use strata_identifiers::{AccountId, Epoch};

use super::schemas::AccountGenesisSchema;
...
impl AccountGenesisDatabase for AccountGenesisDBSled {
