...
pub enum ReplayError {
    /// The chain spec does not initialize the genesis reconstructor.
    ...
    /// The supplied snapshot seed does not produce its claimed state root.
    ...
    /// The reconstructor fails to seed from the snapshot state.
