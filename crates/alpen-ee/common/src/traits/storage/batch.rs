...
#[cfg(feature = "test-utils")]
pub use in_memory::InMemoryBatchStorage;

/// Tests for InMemoryBatchStorage using the standard test suite.
#[cfg(all(test, feature = "test-utils"))]
mod in_memory_tests {
    use super::InMemoryBatchStorage;
    crate::batch_storage_tests!(InMemoryBatchStorage::new());
}
