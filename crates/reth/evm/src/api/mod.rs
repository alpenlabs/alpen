...
pub struct AlpenEvm<DB: Database, I> {
    pub inner: EvmCtx<
        EthEvmContext<DB>,
        I,
...
impl<DB: Database, I> Deref for AlpenEvm<DB, I> {
...
impl<DB: Database, I> DerefMut for AlpenEvm<DB, I> {
    #[inline]
...
impl<DB, INSP> EvmTr for AlpenEvm<DB, INSP>
where
    DB: Database,
{
...
impl<DB, INSP> InspectorEvmTr for AlpenEvm<DB, INSP>
where
    DB: Database,
...
/// <https://github.com/alloy-rs/evm/blob/e0553874c4a4e2b5c32fe328cd5beb2b510f5955/crates/evm/src/eth/mod.rs#L107-L232>
impl<DB, I> Evm for AlpenEvm<DB, I>
where
    DB: Database,
