...
mod tests {
    ...
    fn test_build_chunked_envelope_txs_single_chunk() {
        ...
        assert_eq!(result.commit_tx.output.len(), 2, "commit should have P2TR + change");
        ...
        assert_eq!(reveal.output[0].value.to_sat(), 0, "tag output should be 0 value");
        assert_eq!(
    ...
    fn test_build_chunked_envelope_txs_multiple_chunks() {
        ...
        assert_eq!(result.commit_tx.output.len(), 4, "commit should have 3 P2TR + change");
    ...
    fn test_wtxid_chain_linking() {
        ...
        let wtxid_0: Buf32 = result.reveal_txs[0]
            .compute_wtxid()
            .as_byte_array()
            .into();
        ...
        let wtxid_1: Buf32 = result.reveal_txs[1]
            .compute_wtxid()
            .as_byte_array()
            .into();
