...
pub(crate) struct MempoolEntry {
    /// Transaction body shared with active assembly snapshots.
    pub(crate) tx: Arc<OLTransactionV1>,

    /// Arrival time used to prioritize eligible transactions.
...
impl MempoolEntry {
    ...
    pub(crate) fn new(tx: OLTransactionV1, timestamp_micros: u64, size_bytes: usize) -> Self {
        Self {
            tx: Arc::new(tx),
            timestamp_micros,
            size_bytes,
