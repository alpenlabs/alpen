...
fn test_verify_header_continuity_failures() {
    ...
    assert!(matches!(
        verify_header_continuity(&bad_child, Some(&parent)).expect_err("wrong parent should fail"),
    ...
    assert!(matches!(
        verify_header_continuity(&child_epoch_skip, Some(&parent))
            .expect_err("epoch skip should fail"),
    ...
    assert!(matches!(
        verify_header_continuity(&child_slot_skip, Some(&parent))
            .expect_err("slot skip should fail"),
    ...
    assert!(matches!(
        verify_header_continuity(&non_genesis, None)
            .expect_err("non-genesis without parent should fail"),
    ...
    assert!(matches!(
        verify_header_continuity(&bad_genesis, None).expect_err("genesis with parent should fail"),
...
fn test_verify_header_continuity_rejects_nonterminal_genesis() {
    ...
    assert!(matches!(
        verify_header_continuity(&genesis, None)
            .expect_err("nonterminal genesis should fail continuity"),
