...
fn test_snark_update_emits_log() {
    ...
    let snark_serial = fixture.account_serial(snark_id);
    let pre_msg_idx = fixture.expect_snark_account(snark_id).next_inbox_msg_idx();
    ...
    let log = output.expect_typed_log::<SnarkAccountUpdateLogData>(snark_serial);
    assert_eq!(
