...
mod tests {
    ...
    fn test_apply_batch_updates_existing_account() {
        ...
        let mut batch = WriteBatch::new_from_state(&state);
        let snark_state_updated = OLSnarkAccountState::new_fresh(
            PredicateKey::always_accept(),
            [1u8; 32].into(),
            Vec::new(),
        );
    ...
    fn test_apply_batch_multiple_changes() {
        ...
        let snark_state_1 = OLSnarkAccountState::new_fresh(
            PredicateKey::always_accept(),
            [0u8; 32].into(),
            Vec::new(),
        );
        ...
        let snark_state_2 = OLSnarkAccountState::new_fresh(
            PredicateKey::always_accept(),
            [1u8; 32].into(),
            Vec::new(),
        );
    ...
    fn test_apply_batch_creates_and_updates_accounts() {
        ...
        let updated_snark = OLSnarkAccountState::new_fresh(
            PredicateKey::always_accept(),
            [1u8; 32].into(),
            Vec::new(),
        );
        ...
        let new_snark = OLSnarkAccountState::new_fresh(
            PredicateKey::always_accept(),
            [2u8; 32].into(),
            Vec::new(),
        );
