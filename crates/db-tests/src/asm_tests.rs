use strata_asm_common::{AnchorState, AsmManifestMmr, ChainViewState, ASM_MANIFEST_MMR_CAP_LOG2};
    ...
    let state = AsmState::new(
        AnchorState {
            chain_view: ChainViewState {
                ...
                manifest_mmr: AsmManifestMmr::new(ASM_MANIFEST_MMR_CAP_LOG2).into(),
            },
            sections: vec![],
        },
        vec![],
