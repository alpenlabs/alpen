...
use bitcoin_primitives::{BlockHash, absolute};
use borsh::{BorshDeserialize, BorshSerialize};
use hex::encode_to_slice;
use serde::{Deserialize, Deserializer, Serialize, Serializer, de, ser};

use crate::{buf::*, hash::sha256d};
...
#[cfg(feature = "fullbtc")]
impl From<bitcoin::BlockHash> for L1BlockId {
    fn from(value: bitcoin::BlockHash) -> Self {
        use bitcoin::hashes::Hash;
        Self::from(Buf32::from(value.as_raw_hash().to_byte_array()))
    }
}

#[cfg(feature = "fullbtc")]
impl From<L1BlockId> for bitcoin::BlockHash {
    fn from(value: L1BlockId) -> Self {
        // eww
...
// TODO make this just use u32 everywhere
...
impl L1BlockCommitment {
    ...
    /// Annoying conversion because of mixed up crates.
    #[cfg(feature = "fullbtc")]
    pub fn new_btc(height: bitcoin::absolute::Height, blkid: L1BlockId) -> Self {
        // Safe conversion.
        Self::from_height_u64(height.to_consensus_u32() as u64, blkid).unwrap()
    }
    ...
    /// Get the block height as a `bitcoin` crate u32.
    #[cfg(feature = "fullbtc")]
    pub fn height(&self) -> bitcoin::absolute::Height {
        // Safe conversion.
        bitcoin::absolute::Height::from_consensus(self.height.to_consensus_u32()).unwrap()
    }

    /// Gets the height as a u32.
