...
pub(crate) mod tests {
    ...
    pub fn test_store_and_get_ee_account_state(db: &impl EeNodeDb) {
        // Create test data
        let slot = 100u64;
    ...
    pub fn test_sequential_slots(db: &impl EeNodeDb) {
    ...
    pub fn test_null_block_rejected(db: &impl EeNodeDb) {
    ...
    pub fn test_rollback_ee_account_state(db: &impl EeNodeDb) {
    ...
    pub fn test_empty_database(db: &impl EeNodeDb) {
    ...
    pub fn test_rollback_empty_database(db: &impl EeNodeDb) {
    ...
    pub fn test_sequential_writes_and_retrieval(db: &impl EeNodeDb) {
        let num_blocks = 10;
