...
use super::l2::{get_highest_l2_slot, get_l2_block_slot, get_latest_l2_block_id};
<<<<<<< HEAD
use crate::{
    cli::OutputFormat,
...
>>>>>>> 5945979f (implement get-chainstate and revert-chainstate)
...
pub(crate) fn revert_chainstate(
    ...
    for slot in target_slot + 1..=latest_slot {
        ...
        for block_id in l2_block_ids.iter() {
            ...
            // Mark the status to unchecked if requested
