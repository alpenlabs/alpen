...
pub(crate) struct SyncInfo<'a> {
    ...
    pub ol_tip_height: u64,
    pub ol_tip_block_id: &'a OLBlockId,
    pub ol_tip_block_status: &'a BlockStatus,
    pub ol_finalized_block_id: &'a OLBlockId,
    pub current_epoch: u64,
    pub current_slot: u64,
    pub previous_block: &'a OLBlockCommitment,
