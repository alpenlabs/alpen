...
Please do not open unsolicited pull requests in this repository.
Maintainers may close pull requests without review.
...
> [!IMPORTANT]
>
> If you are using **any kind of AI assistance** in an approved contribution
...
The remaining guidance is intended for Alpen Labs maintainers and approved
collaborators.
...
Before you create an approved PR, make sure that all the required CI checks pass locally.
